...
-- ---------- staff.employees ----------
INSERT INTO staff.employees (id, first_name, last_name, role, email, phone)
VALUES                                                                             
...
-- ---------- clients.customers ----------
INSERT INTO clients.customers (id, first_name, last_name, email, phone, id_number) 
VALUES                                                                                       
...
-- ---------- inventory.cars ----------
INSERT INTO inventory.cars (id, vin, make, model, year, color, price, mileage, type, status) 
VALUES                                                                                                 
...
-- ---------- new_sales.transactions ----------
INSERT INTO new_sales.transactions (id, car_id, client_id, staff_id, sales_price, status) 
VALUES
...
-- ---------- used_sales.transactions ----------
INSERT INTO used_sales.transactions (id, car_id, client_id, staff_id, sale_price, trade_in_id, status) 
VALUES
...
-- ---------- financing.applications ----------
INSERT INTO financing.applications (id, sale_id, client_id, loan_amount, term_months, monthly_payment, status) 
VALUES
...
-- ---------- accessories.orders ----------
INSERT INTO accessories.orders (id, item_id, quantity, status) 
VALUES
...
-- ---------- maintenance.jobs ----------
INSERT INTO maintenance.jobs (id, car_id, client_id, staff_id, description, status, scheduled) 
VALUES
